...
//les méthodes qui touchet le backend
//createAsyncThunk : siginifie qu'on va communiquer avec le backend
...
export const findArticleByID = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
        ...
        try {
            ...
            //res.data est le retour du backend
            return res.data;
        }
        catch (error) {
            return rejectWithValue(error.message);
...
//les méthodes qui modifient le state après le backend
        ...
        builder
            ...
            .addCase(updateArticle.fulfilled, (state, action) => {
                state.articles = state.articles.map((item) =>
                    //comparaison des id des 2 articles : on change l'ancien article par le nouveau 
